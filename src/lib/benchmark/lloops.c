...
static double      runSecs = 1;
static Boolean     reliability = FALSE;
static Boolean     runRel;
static Boolean     nsRes = FALSE;
static double      sumscomp[3][25];
static int         compareFail = 0;
static int         failCount;
#ifdef NON_BAREMETAL
FILE        *outfile;
#endif
static  void init(long which);
...
static  long parameters(long which);
