...
#endif
{
       ...
       lda = 201;
        ...
        printf( "%s ", ROLLING);
        printf( "%s ", PREC);
        printf("Precision Linpack Benchmark - Linux Version in 'C/C++'\n\n");
...
{
printf("%11.5f",   (double)atime[0][row]);
printf(        "%11.5f",(double)atime[1][row]);
printf(        "%11.5f", (double)atime[2][row]);
printf(        "%11.2f", (double)atime[3][row]);
printf(        "%11.4f",(double)atime[4][row]);
printf(        "%11.4f\n", (double)atime[5][row]);
       return;
}
